...
#undef RGB_DI_PIN
#define RGB_DI_PIN  SCROLL_DI_PIN
/*
...
static inline void scroll_sendarray_mask(uint8_t *data, uint16_t datlen, uint8_t masklo, uint8_t maskhi);

void scroll_setleds(LED_TYPE *ledarray, uint16_t number_of_leds) {
    ...
    scroll_sendarray_mask((uint8_t *)ledarray, number_of_leds * sizeof(LED_TYPE), masklo, maskhi);
